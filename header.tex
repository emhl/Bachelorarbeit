...
%--------------------------GRUNDEINSTELLUNGEN--------------------%
%----------------------------------------------------------------%
\documentclass[oneside, ngerman, footinclude=on, captions=tableheading,]{scrartcl}
...
\addtolength{\textheight}{3.5cm} % verkleinert fußzeile
...
\usepackage{dsfont}                                 %   ermöglicht Schreiben der Symbole von Mengen wie den Ganzen Zahlen							
