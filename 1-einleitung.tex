...
Im zweiten Kapitel werden werden die theoretischen Grundlagen für die Arbeit gelegt. Dafür wird zunächst die magnetische Dynamik von Orthoferrit anhand des Heisenberg Modells und der Landau-Lifschitz-Gilbert Gleichung beschrieben und die Modellierung des \ce{Sm_{0.7}Er_{0.3}FeO3} Kristalls erläutert.
