...
\begin{figure}[H]
	\centering
	\subcaptionbox{\(T = \qnt{0}{\kelvin} \)}{\includegraphics[width=0.45\textwidth]{bilder/jschlege/LLG_T0_labeled.png}}
	\subcaptionbox{\(T \gg \qnt{0}{\kelvin} \)}{\includegraphics[width=0.45\textwidth]{bilder/jschlege/LLG_labeled.png}}
