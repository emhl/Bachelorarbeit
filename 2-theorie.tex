...
\todo{verweis literatur mit Herleitung}
...
\todo{erklärung indirekt antisymmetrische Interaktion}
...
\todo{kristalline Anisotropien erklären}
...
\todo{erkllärung leichte und harte Achse}
...
\todo{paralelle Ausrichtung im gegensatz zu Anisotropie}
...
\todo{Herleitung Hamiltonfunktion}
...
Das Ehrenfest-Theorem besagt, dass die zeitliche Änderung des Erwartungswertes eines Operators gleich dem Erwartungswert des Kommutators des Operators mit der Hamiltonfunktion ist
\cite{qm-1-Schwabl}:
...
\begin{figure}[H]
	\centering
	\subcaptionbox{\(T = \SI{0}{\kelvin} \)}{\includegraphics[width=0.45\textwidth]{bilder/jschlege/LLG_T0_labeled.png}}
	\subcaptionbox{\(T \gg \SI{0}{\kelvin} \)}{\includegraphics[width=0.45\textwidth]{bilder/jschlege/LLG_labeled.png}}
...
bildet Erbium (\ce{Er}) diese Restgruppe. \todo{Samarium jetzt oder erst
	später?}
...
(\ce{Sm_{0.7}Er_{0.3}FeO3}) liegt sie ungefähr bei Raumtemperatur, weshalb es
im Experiment einfacher zu untersuchen ist. \todo{Zitat Fitzky}
...
\todo{erklärung Realisation Reorientierungsübergang}

\todo{Projektion xyz \(\to\) abc}

\begin{figure}[htbp]
	\centering
	\subcaptionbox{Einheitszelle mit DMI Vektoren(gelb)\label{subfig:orthoferrit-dmi}}{\includegraphics[width=0.3\textwidth]{bilder/jschlege/UnitCell_withDMI_labeled.png}}
	\subcaptionbox{Einheitszelle mit magnetischen Momenten (grün) für \(T<T_l\)\label{subfig:orthoferrit-below-rt}}{\includegraphics[width=0.3\textwidth]{bilder/jschlege/UnitCell_belowRT.png}}
	\subcaptionbox{Einheitszelle mit magnetischen Momenten (grün) für \(T>T_h\)\label{subfig:orthoferrit-above-rt}}{\includegraphics[width=0.3\textwidth]{bilder/jschlege/UnitCell_aboveRT.png}}
