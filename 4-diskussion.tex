...
Diese Verteilung ist für den Temperaturbereich mit aktivem Telegrafenrauschen deutlich breiter, als oberhalb und unterhalb. \todo{warum?}
...
\begin{figure}[H]
    ...
    \caption{Die Aufenthaltszeit im oberen Zustand mit einer Sigmoid-Funktion gefittet \todo{quelle der Datenpunkte (mittelwert?)}}\label{fig:bz-up-percentage}
\end{figure}
