...
\todo{Spektrale betrachtung der daten in daten in \cref{eq:autocorr}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{bereich mit sichtbarem TGR\label{fig:temp-hist-tg}}{    \includegraphics{bilder/plots/temp_comparison/mc_hist.pdf}    }
...
\begin{figure}[H]
    ...
    \caption{temp autocorrelation amplitude diff Rauschamplitude\todo{Rauschamplitude von rohem signal hat mehr relevanz}}\label{fig:temp-autocorr-amplitude-diff}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{source \todo{auch nur bis 50mT} \label{fig:bz-spd-source}}{\includegraphics{bilder/plots/max_Bz/spectral_power_density.pdf}}
...
\begin{figure}[H]
    \centering
    \subcaptionbox{source \todo{auch nur bis 50mT} \label{fig:bz-autocorr-source}}{\includegraphics{bilder/plots/max_Bz/autocorrelation.pdf}}
