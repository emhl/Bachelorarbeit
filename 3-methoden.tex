...
\end{align}
\todo{label Deterministischer teil und stochastischer teil}
...
\todo{etwas mehr Erklärung und verweis zu \cref{fig:fit_comp}}
\begin{figure}[h]
    \centering
...
Viele Algorithmen, die versuchen die Zustände zu bestimmen, haben das Problem, dass sie bei einem Übergang von einem Zustand in den anderen, kurzzeitig in den anderen Zustand springen. Dieses Problem wird als overshoot problem bezeichnet. \todo{ was ist der offizielle name?}
