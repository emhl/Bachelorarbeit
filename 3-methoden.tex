...
% \todo{Erklärung wie die numerische lösung von Differentialgleichungen funktioniert}
...
\end{align}\todo{\(h\) vor summe weglassen?}


% \todo{warum müssen die Spins nach jedem schritt normiert werden?}
...
Viele Algorythmen, die versuchen die Zustände zu bestimmen, haben das Problem, dass sie bei einem Übergang von einem Zustand in den anderen, kurzzeitig in den anderen Zustand springen. Dieses Problem wird als overshoot problem bezeichnet. \todo{ was ist der offizielle name?}
...
% \todo{Erklärung eigener Abwandlung, welche weniger komplex als \cite{random-telegraph-analysis} ist und trotzdem das overshoot problem löst}
...
\begin{figure}[h]
    ...
    \caption{Histogramm des Rauschsignals aus \cref{fig:fit_comp} mit Gaußfits für das obere, und das untere Niveau\todo{gauss plot nur im gefitteten interval?}}
\end{figure}
...
% \todo{plot mit zuständen und zustandswechsel}
...
\todo{gibt es teilweise ein undershoot problem?}
